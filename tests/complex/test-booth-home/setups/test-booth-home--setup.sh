...
# -----------------------------------------------------------------------------
# test-booth-home--setup.sh
#
# Test setup script that:
# 1. Creates a file in /home/coder during build (BEFORE .booth/home is copied)
...
echo "Setting up test for .booth/home..."

# Create the test file in /home/coder DURING BUILD
# This file should NOT be overwritten by .booth/home (no-clobber behavior)
mkdir -p /home/coder
...
# This allows testing that .booth/home CAN copy files when they don't exist

# Create a startup script that logs the file content
cat > /usr/share/startup.d/70-cb-test-booth-home--startup.sh << 'STARTUP'
#!/usr/bin/env bash
# Startup script to log the test file content for verification
echo "=== .booth/home test startup ===" >> /tmp/startups.log
...
chmod 755 /usr/share/startup.d/70-cb-test-booth-home--startup.sh

echo "Test setup for .booth/home complete."
