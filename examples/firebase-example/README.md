...
This example demonstrates using `ws-home-seed` to mount Firebase credentials from your host machine into the container.
...
The `.ws/config.toml` mounts Firebase-related config directories read-only to `/tmp/ws-home-seed/`.
