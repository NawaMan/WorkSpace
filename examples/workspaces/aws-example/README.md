...
This example demonstrates using `cb-home-seed` to mount AWS credentials from your host machine into the container.
...
The `.booth/config.toml` mounts `~/.aws/` read-only to `/etc/cb-home-seed/.aws/`.
